...
import type { AnyGPTConfig, MCPServerRuleTarget } from '@anygpt/types';
...
export interface Plugin {
   ...
   */
  config?: (context: PluginContext) => Partial<AnyGPTConfig> | Promise<Partial<AnyGPTConfig>>;
   ...
   */
  configResolved?: (config: AnyGPTConfig, context: PluginContext) => AnyGPTConfig | Promise<AnyGPTConfig>;
}
